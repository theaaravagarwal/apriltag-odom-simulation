#!/usr/bin/env python3
"""
Simulation-integrated AprilTag detection and validation system.
Captures frames from the simulation and validates detections in real-time.
"""
...
class SimulationTagDetector:
    ...
    def run_detection_loop(self):
        ...
        print("Starting simulation-integrated AprilTag detection...")
...
def main():
    parser = argparse.ArgumentParser(description="Simulation-integrated AprilTag detection and validation")
